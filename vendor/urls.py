...
from vendor.apis.purchase_order.view_po_acknowledge import PoAcknowledge
...
urlpatterns = [
    ...
    path("vendors/<uuid:vendor_id>/performance/", ManageVendor.as_view(), name="vendor-detail"),
    ...
    path("purchase_orders/<uuid:po_id>/acknowledge/", PoAcknowledge.as_view()),
